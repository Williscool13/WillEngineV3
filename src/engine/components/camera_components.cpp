...
void Engine::Component::FreeCameraComponent::Serialize(const FreeCameraComponent& comp, Engine::TextWriter& w)
{
...
void Engine::Component::FreeCameraComponent::Deserialize(FreeCameraComponent& comp, const Engine::TextReader& r)
{
