...
void Engine::Component::DebugGizmoComponent::Serialize(const DebugGizmoComponent& comp, Engine::TextWriter& w)
{
...
void Engine::Component::DebugGizmoComponent::Deserialize(DebugGizmoComponent& comp, const Engine::TextReader& r)
{
