...
constexpr CompressionType DEFAULT_STATIC_MODEL_COMPRESSION = CompressionType::Zstd;
constexpr CompressionType DEFAULT_TEXTURE_COMPRESSION = CompressionType::Zstd;
constexpr CompressionType DEFAULT_ENV_MAP_COMPRESSION = CompressionType::Zstd;
constexpr CompressionType DEFAULT_FONT_COMPRESSION = CompressionType::Zstd;
