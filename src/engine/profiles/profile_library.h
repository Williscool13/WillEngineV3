 ...
 * A lighting profile bundles the LightingMode + ReSTIRParams (incl. RELAX) + GTAOConfiguration + IBL intensity + the shading/lighting shader overrides; a post-process profile is a PostProcessConfiguration.
