...
private:
    ...
    Core::ConcurrentQueue<AudioLoadRequest> audioRequestQueue;
    Core::ConcurrentQueue<AudioLoadComplete> audioLoadCompleteQueue;
    ...
    Core::ConcurrentQueue<PipelineLoadRequest> pipelineRequestQueue;
    Core::ConcurrentQueue<PipelineLoadComplete> pipelineLoadCompleteQueue;
    ...
    Core::ConcurrentQueue<StaticModelLoadRequest> modelRequestQueue;
    Core::ConcurrentQueue<StaticModelLoadComplete> modelLoadCompleteQueue;
    ...
    Core::ConcurrentQueue<StaticModelLoadRequest> proceduralModelRequestQueue;
    Core::ConcurrentQueue<StaticModelLoadComplete> proceduralModelLoadCompleteQueue;
    ...
    Core::ConcurrentQueue<PhysicsColliderLoadRequest> physicsColliderRequestQueue;
    Core::ConcurrentQueue<PhysicsColliderLoadComplete> physicsColliderLoadCompleteQueue;
    ...
    Core::ConcurrentQueue<TextureLoadRequest> textureRequestQueue;
    Core::ConcurrentQueue<TextureLoadComplete> textureLoadCompleteQueue;
