...
inline constexpr int32_t RDG_MAX_SAMPLED_TEXTURES = 512;
inline constexpr int32_t RDG_MAX_SAMPLED_FLOAT2 = 256;
...
inline constexpr int32_t RDG_MAX_STORAGE_FLOAT2 = 256;
