...
SHADER_PUBLIC SHADER_CONST uint REFLECTION_SUN_SHADOW_RAY = 0u;
SHADER_PUBLIC SHADER_CONST uint REFLECTION_SUN_ALWAYS_LIT = 1u;
SHADER_PUBLIC SHADER_CONST uint REFLECTION_SUN_ALWAYS_UNLIT = 2u;

SHADER_PUBLIC SHADER_CONST uint REFLECTION_HIT_SHADOW_RAYS_MAX = 4u;
