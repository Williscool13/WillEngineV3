...
SHADER_PUBLIC SHADER_CONST uint REGIR_GRID_DIM = 32u;
SHADER_PUBLIC SHADER_CONST uint REGIR_CELL_COUNT = REGIR_GRID_DIM * REGIR_GRID_DIM * REGIR_GRID_DIM;
SHADER_PUBLIC SHADER_CONST uint REGIR_RESERVOIRS_PER_CELL = 16u;
SHADER_PUBLIC SHADER_CONST uint REGIR_FILL_CANDIDATES = 16u;
SHADER_PUBLIC SHADER_CONST float REGIR_CELL_SIZE = 3.0;
