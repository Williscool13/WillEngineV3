 ...
 * @param outEntries Receives `count` entries; caller allocates `count`. When total power is 0 (or count is 0) the table degenerates to a uniform 1/count sampler so the estimator stays well-defined.
