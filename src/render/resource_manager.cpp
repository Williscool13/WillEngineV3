    ...
    : context(context)
{
    ...
    bindlessRDGRTDescriptorBuffer = BindlessRDGRTResourcesDescriptorBuffer<RDG_MAX_TLAS>(context);
    ...
    smaaSearchGenerateResources = Render::BindlessResourcesStorage<1>(context);
#endif
}
} // Render
